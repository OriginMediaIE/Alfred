...
class MemoryProvider(ABC):
    """Base contract for OM Automate memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for OM Automate's built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "OM Automate native memory"

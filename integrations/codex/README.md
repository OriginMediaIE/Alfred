# OM Automate Codex Integration

This directory contains the Codex plugin/skill bundle for OM Automate.

## User Flow

1. Open OM Automate Settings > Integrations.
2. Add a Codex Agent.
...
Codex must use `/api/codex/*` endpoints. SSH, Docker, direct Python imports, database queries, and MCP internals bypass OM Automate Settings and must not be used for user data access.

# OM Automate Claude Code Integration

This directory contains the Claude Code skill bundle for OM Automate.
...
The token is scope-gated. Every tool surface is checked server-side in OM Automate,
